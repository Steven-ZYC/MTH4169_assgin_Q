...
%	\end{figure}
	...
	Now we add a little complexity to the game. We only change the number of chambers to 3. Now the game involves: $N = 3$, $n = 1$, $m = 2$, no spinning.\\[4pt]
	...
	\[
	\mathbb{P}(\text{Player 1 survives}) = 1 - \tfrac{1}{3} = \tfrac{2}{3}
	\]
	\[
	\mathbb{P}(\text{Player 2 dies} \mid \text{Player 1 survives}) = \tfrac{1}{2}
	\]
	\begin{align*}
		\mathbb{P}(P_2 \text{ dies})
		&= \mathbb{P}(P_1 \text{ survives}) \cdot \mathbb{P}(P_2 \text{ dies} \mid P_1 \text{ survives}) \\
		&= \Bigl(1 - \tfrac{1}{3}\Bigr) \cdot \tfrac{1}{2} = \tfrac{1}{3}
	\end{align*}
	...
	\subsection{\textbf{Optimal Stopping Problem (e)}}
	...
	\end{adjustwidth}
		...
		\begin{adjustwidth}{2em}{0pt}
			...
			\begin{align*}
				k_{max}=\lfloor \frac{C+2-n}{2}\rfloor
			\end{align*}
			...
			\begin{enumerate}
				...
				\end{enumerate}
				$V_3=\frac{1}{2}\times (-1)+\frac{1}{2}\times (10)=0.5+5=4.5$\\
				...
				\begin{table}[h]
					...
					\begin{tabular}{cccccccc}
						\toprule
						C & n & $V_1$ & $V_2$ & $V_3$ & $V_4$ & $V_5$ & Optimal Strategy \\
						\midrule
						6 & 1 & 4.50 & 4.50 & 4.50 & N.A. & N.A. &Never forfeit\\
						6 & 2 & 3.40 & 2.67 & -1 & N.A. & N.A. & Forfeit before R3 \\
						6 & 3 & 2.85 & 1.75 & N.A. & N.A. & N.A. & Play through R2 \\
						8 & 1 & 4.50 & 4.50 & 4.50 & 4.50 & N.A. & Never forfeit\\
						8 & 2 & 3.71 & 3.40 & 2.67 & -1 & N.A. & Forfeit before R4 \\
						10 & 1 & 4.50 & 4.50 & 4.50 & 4.50 & 4.50 & Never forfeit\\
						10 & 2 & 3.89 & 3.71 & 3.40 & 2.67 & -1 & Forfeit before R5\\
						10 & 3 & 3.58 & 3.32 & 2.85 & 1.75 & N.A. & Never forfeit\\
						10 & 5 & 2.75 & 2.14 & 0.83 & N.A. & N.A & Play through R3\\
						\bottomrule
					\end{tabular}
				\end{table}
			\end{enumerate}
		...
		\begin{adjustwidth}{2em}{0pt}
			...
			\begin{itemize}
				...
				\item $r \geq 0.4$, it is most likely optimal to forfeit early (after 1 or 2 rounds).\\
			\end{itemize}
	...
	\section{Simulation}
		...
		players surviving.  Repeating this procedure for 150,000 independent games,
